            ...
            <div className="top-area text-white p-5">
                ...
                <div className="row justify-content-start">
                    <div className="col-9 col-sm-7">
                        <img className="img-fluid" src="./images/webdev/eyec/eyec_10.png" alt="Design case photo" />
                    ...
                    <div className="col-11 col-sm-5">
                        <img className="img-fluid" src="./images/design/aoi_6.jpg" alt="Design case photo" />
            ...
            <div className="container-fluid pb-5">
                ...
                <div className="row justify-content-around mt-5">
                    <div className="col-11 col-sm-5 align-self-start pb-5">
                        <img className="bg-aoi img-fluid" src="./images/design/aoi_gif.gif" alt="Design case photo" />
                    ...
                    <div className="col-11 col-sm-5 align-self-end">
                        <img className="img-fluid" src="./images/design/moldxaoi.jpg" alt="Design case photo" />
                ...
                <div className="row justify-content-around mb-5">
                    <div className="col-11 col-sm-5 align-self-top">
                        <img className="img-fluid" src="./images/design/aoi_10.jpg" alt="Design case photo" />
                        <p><small>Recycled paper hangtag and cotton label for Aoi.</small></p>
                    </div>
                    <div className="col-11 col-sm-4 align-self-center pt-5">
                        <img className="img-fluid" src="./images/design/eyec_eg.png" alt="Design case photo" />
                ...
                <div className="row justify-content-around mt-5 mb-5">
                    <div className="col-11 col-sm-3 m-auto">
                        <img className="img-fluid" src="./images/design/aoi_7.jpg" alt="Design case photo" />
                        <p><small>Packaging design for Aoi <Link className="text-reset case-link" to="/cases/aoi">View case study+</Link></small></p>
                    </div>
                    <div className="col-11 col-sm-5">
                        <img className="img-fluid" src="./images/design/aoi_font.png" alt="Design case photo" />
