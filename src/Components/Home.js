    ...
    return(
        ...
        <div id="home-container">
            ...
            <div className="container-fluid">
                ...
                <div className="top-area padded-area text-white text-center row justify-content-center">
                ...
                <div className="row justify-content-center mt-3">
                    ...
                    <p className="col-3 text-right"><Link className="text-reset case-link" to="/cases/eyec">View case study+</Link></p>
                </div>
                ...
                <div className="row justify-content-center mt-3">
                    ...
                    <p className="col-3 text-right"><Link className="text-reset case-link" to="/cases/aoi">View case study+</Link></p>
                </div>
                ...
                <div className="row justify-content-center mt-3 mb-5">
                    ...
                    <p className="col-3 text-right"><Link className="text-reset case-link" to="/cases/gtf">View case study+</Link></p>
                </div>
            </div>
        </div>
